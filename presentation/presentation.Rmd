...
- initialement je pensais que c'était lourd (je pensais le réserver pour des projets à déployer) mais j'ai découvert l'existence du cache.
...
- Si vous n'êtes pas passé à R>=4, y passer avant de se mettre à utiliser renv.
