...
- initialement je pensais que c'était lourd (je pensais le réserver pour des projets à déployer) et puis j'ai découvert l'existence du cache.
...
Et si pas activé : `renv::activate()`
...
- renv marche même sans RStudio, et sans "projet" RStudio. C'est en particulier le .Rprofile et les fichiers de renv qui vont activer renv au niveau du dossier. (Mais personnellement je recommande l'utilisation des .Rproj)
